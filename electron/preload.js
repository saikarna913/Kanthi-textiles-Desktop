...
contextBridge.exposeInMainWorld('electron', {
  ...
  db: {
    ...
    deleteAllSales: () => invoke('db:deleteAllSales'),
    ...
    getProductMonthlySales: (p) => invoke('db:getProductMonthlySales', p),
    getMonthOverMonth: (p) => invoke('db:getMonthOverMonth', p),
    getCategoryMonthly: (p) => invoke('db:getCategoryMonthly', p),
